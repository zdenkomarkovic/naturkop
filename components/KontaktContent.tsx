...
export default function KontaktContent() {
  return (
    <main className="min-h-screen bg-[#ebe8e6]">
      {/* Hero sekcija */}
      ...
      <section className="py-10 md:py-16">
        <div className="  max-w-6xl mx-auto px-4">
          <div className="grid lg:grid-cols-2 md:gap-12 gap-4 items-center">
            ...
            >
              {/* Kontakt informacije */}
              <div className="bg-white p-6 rounded-xl shadow-lg shadow-[#9b7e74]">
                <div className=" space-y-2">
                  <p>
                    ...
                    <a
                      ...
                      className="text-[#9b7e74] hover:text-[#8a6e65] transition-colors"
                    >
